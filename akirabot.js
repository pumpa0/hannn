...
const lolhuman = 'AkiraYT' //Besok Beli Sendiri
const onlydev = 'OnlyOneDevelover' //Free Apikey
const xteam = 'AkiraBotWa' //Hari Jumat Habis

//Ubah
const namaowner = 'Akira'
...
║┣❏ Nama : Akira
║┣❏ Github : AkiRaID
║┣❏ Rest API : akirainfo.site
║┣❏ Youtube : あAkiRa
║┣❏ Instagram : @akirashopreal
║┃
║┣━━⊱*「 INFO BOT」* 
║┃
║┣❏ ON : ${kyun(uptime)}
...
` 
		...
		if (isBanned) return reply(ind.baned())
            ...
            case 'creator':
                  ...
                  akira.sendMessage(from, 'Tuh kontak ${namaowner} <•_•> ,Jangan Lupa Save Ya (*>*)',MessageType.text, { quoted: mek} )
